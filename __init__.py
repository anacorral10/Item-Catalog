...
# imports for unique session tokens
from flask import session as login_session
import random
import string
# imports for handling code sent back from the callback method
...
# Round trip verification confirm token client sends to the server matches
# the token servers send to client
...
def gconnect():
    ...
    # Check and see if a user is already logged in
